...
class _ReminderScreenState extends State<ReminderScreen> {
  ...
  Future<void> selectDate(BuildContext context, String text) async {
    ...
    await context.read<ReminderCubit>().addReminder(text, finalDateTime);
  }
                            ...
                            return Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  "${item.reminderDateTime.hour.toString().padLeft(2, '0')}:"
                                  "${item.reminderDateTime.minute.toString().padLeft(2, '0')}",
